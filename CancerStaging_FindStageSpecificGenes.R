...
for (normalization_scheme in normalization_schemes)
{
	...
	# First, I will load the statistic table   	
	normalized_expression_table<-read.table(file = paste("/home/felipe/Documents/Cancer_staging/df_reads_count_all_projects_",normalization_scheme,".tsv",sep="") , sep = '\t', header = TRUE,fill=TRUE)
