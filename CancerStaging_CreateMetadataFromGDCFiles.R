...
#cat /home/felipe/googledrive/Cancer_staging/sample.tsv | sed "s/'--/ /g" > /home/felipe/googledrive/Cancer_staging/clinical.txt
...
sample_file="/home/felipe/googledrive/Cancer_staging/clinical.txt"    
...
sum(unique(merged_data_patient_info[,c("sample_id","Sample.Type")])[,2]=="Metastatic") # Number of Solid Tissue Normal
