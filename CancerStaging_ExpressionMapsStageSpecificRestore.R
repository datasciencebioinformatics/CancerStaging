...
{     
    ...
    dev.off()
    #########################################################################################################################################
    m1<-ggplot(Interactomes_GC3_T2_merged_Stage_I, aes(Conections, GC3, z = AveExp))   + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+  geom_vline(xintercept=mean(Interactomes_GC3_T2_merged_Stage_I$Conections), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(Interactomes_GC3_T2_merged_Stage_I$GC3), linetype="dashed", color = "red")     + geom_vline(xintercept=median(Interactomes_GC3_T2_merged_Stage_I$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_I$GC3), linetype="dashed", color =   "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(25,85)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 10), limits = c(25, 85)) + geom_contour()
...
{     
    ...
    m7<-ggplot(Interactomes_GC3_T2_merged_Stage_I, aes(Conections, GC3, z = value))    + geom_point(aes(colour=value))   +  theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+  xlim(0, 50)       + geom_vline(xintercept=mean(Interactomes_GC3_T2_merged_Stage_I$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(Interactomes_GC3_T2_merged_Stage_I$GC3), linetype="dashed", color = "red")     + geom_vline(xintercept=median(Interactomes_GC3_T2_merged_Stage_I$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_I$GC3), linetype="dashed", color =   "yellow")   + ylim(25,85) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(25,85)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(0, 40, by = 10), limits = c(25, 85))
    m8<-ggplot(Interactomes_GC3_T2_merged_Stage_II, aes(Conections, GC3, z = value))   + geom_point(aes(colour=value))  +  theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+ xlim(0, 50) + geom_vline(xintercept=mean(Interactomes_GC3_T2_merged_Stage_II$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(Interactomes_GC3_T2_merged_Stage_II$GC3), linetype="dashed", color = "red")   + geom_vline(xintercept=median(Interactomes_GC3_T2_merged_Stage_II$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_II$GC3), linetype="dashed", color =  "yellow")   + ylim(25,85) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(25,85)  + xlim(0, 50)       + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(0, 40, by = 10), limits = c(25, 85))
    m9<-ggplot(Interactomes_GC3_T2_merged_Stage_III, aes(Conections, GC3, z = value))  + geom_point(aes(colour=value)) + theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))+ xlim(0, 50) +  geom_vline(xintercept=mean(Interactomes_GC3_T2_merged_Stage_III$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(Interactomes_GC3_T2_merged_Stage_III$GC3), linetype="dashed", color = "red") + geom_vline(xintercept=median(Interactomes_GC3_T2_merged_Stage_III$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_III$GC3), linetype="dashed", color = "yellow")   + ylim(25,85) +  guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(25,85)  + xlim(0, 50)     + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(0, 40, by = 10), limits = c(25, 85))
  
    m10<-ggplot(Interactomes_GC3_T2_expr_stageI_unique, aes(Conections, GC3, z = value))   +  theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))   + geom_density_2d(bin=10)         + geom_vline(xintercept=mean(Interactomes_GC3_T2_expr_stageI_unique$Conections), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(Interactomes_GC3_T2_expr_stageI_unique$GC3), linetype="dashed", color = "red")     + geom_vline(xintercept=median(Interactomes_GC3_T2_expr_stageI_unique$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_I$GC3), linetype="dashed", color =   "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(25,85)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(25, 85, by = 10), limits = c(25, 85))
    m11<-ggplot(Interactomes_GC3_T2_expr_stageII_unique, aes(Conections, GC3, z = value))  +  theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))   + geom_density_2d(bin=10)        + geom_vline(xintercept=mean(Interactomes_GC3_T2_expr_stageII_unique$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(Interactomes_GC3_T2_expr_stageII_unique$GC3), linetype="dashed", color = "red")   + geom_vline(xintercept=median(Interactomes_GC3_T2_expr_stageII_unique$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_II$GC3), linetype="dashed", color =  "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(25,85)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(25, 85, by = 10), limits = c(25, 85))
    m12<-ggplot(Interactomes_GC3_T2_expr_stageIII_unique, aes(Conections, GC3, z = value)) +  theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))   + geom_density_2d(bin=10)       + geom_vline(xintercept=mean(Interactomes_GC3_T2_expr_stageIII_unique$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(Interactomes_GC3_T2_expr_stageIII_unique$GC3), linetype="dashed", color = "red") + geom_vline(xintercept=median(Interactomes_GC3_T2_expr_stageIII_unique$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(Interactomes_GC3_T2_merged_Stage_III$GC3), linetype="dashed", color = "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(25,85)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(25, 85, by = 10), limits = c(25, 85))  
      
    # FindClusters_resolution               
    png(filename=paste(output_dir,"countour_T2_Coonections_melt_",normalization_scheme,"_",TCGA_project,"_Stage_unique_GC3.png",sep=""), width = 30, height = 50, res=600, units = "cm")  
            plot<-ggarrange(m4, m5, m6, m7, m8, m9, m10, m11,m12, m1,m2,m3, nrow = 4,ncol = 3, common.legend = TRUE, legend="bottom")
            print(annotate_figure(plot, top = text_grob(TCGA_project, face = "bold", size = 14)))
    dev.off()  
