...
{     
    ...
    # Make a copy without the ovelapping
    merged_expression_table_normalized_all_stages_bck <-merged_expression_table_normalized_all_stages

    merged_expression_table_normalized_all_stages_bck[merged_expression_table_normalized_all_stages_bck$ENSEMBL %in% genes_stages_I,"Stages"]  <-"Stage I"
    merged_expression_table_normalized_all_stages_bck[merged_expression_table_normalized_all_stages_bck$ENSEMBL %in% genes_stages_II,"Stages"] <-"Stage II"
    merged_expression_table_normalized_all_stages_bck[merged_expression_table_normalized_all_stages_bck$ENSEMBL %in% genes_stages_III,"Stages"]<-"Stage III"      
    ...
    colnames(merged_expression_table_normalized_stage_I_bck)[6]<-"Expr"
    colnames(merged_expression_table_normalized_stage_II_bck)[6]<-"Expr"
    colnames(merged_expression_table_normalized_stage_III_bck)[6]<-"Expr"
    colnames(merged_expression_table_normalized_all_stages_bck)[6]<-"Expr"      
    #########################################################################################################################################
    ...
    merged_expression_table_normalized_stage_I_bck<-merged_expression_table_normalized_all_stages_bck[merged_expression_table_normalized_all_stages_bck$Stages=="Stage I",]
    merged_expression_table_normalized_stage_II_bck<-merged_expression_table_normalized_all_stages_bck[merged_expression_table_normalized_all_stages_bck$Stages=="Stage II",]
    merged_expression_table_normalized_stage_III_bck<-merged_expression_table_normalized_all_stages_bck[merged_expression_table_normalized_all_stages_bck$Stages=="Stage III",]
    ...
    m1<-ggplot(merged_expression_table_normalized_stage_I_bkc, aes(Conections, T2, z = Expr))   + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+  geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color =   "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(10,40)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m2<-ggplot(merged_expression_table_normalized_stage_II_bkc, aes(Conections, T2, z = Expr))  + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+  geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color =  "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m3<-ggplot(merged_expression_table_normalized_stage_III_bkc, aes(Conections, T2, z = Expr)) + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))+  geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "red") + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    
    m4 <- ggplot(merged_expression_table_normalized_all_stages_bck, aes(x=Stages, y=T2)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()           +  geom_hline(yintercept=median(merged_expression_table_normalized_all_stages$T2), linetype="dashed", color = "red")    + ggtitle(paste("T2 All points: ", normalization_scheme,sep=""))                   +  stat_compare_means(comparisons = my_comparisons, method = "t.test") 
    m5 <- ggplot(merged_expression_table_normalized_all_stages_bck, aes(x=Stages, y=Conections)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()   +  geom_hline(yintercept=median(merged_expression_table_normalized_all_stages$Conections), linetype="dashed", color = "red")    + ggtitle(paste("Connectivity All points: ", normalization_scheme,sep="")) +  stat_compare_means(comparisons = my_comparisons, method = "t.test") 
    m6 <- ggplot(merged_expression_table_normalized_all_stages_bck, aes(x=Stages, y=Expr)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()         +      geom_hline(yintercept=median(merged_expression_table_normalized_all_stages$Expr), linetype="dashed", color = "red")    + ggtitle(paste("Expr. All points: ", normalization_scheme,sep=""))          +  stat_compare_means(comparisons = my_comparisons, method = "t.test") 

    m7<-ggplot(merged_expression_table_normalized_stage_I_bck, aes(Conections, T2, z = Expr))    + geom_point(aes(colour=Expr))   +  theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+  xlim(0, 50)       + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color =   "yellow")   + ylim(10,40) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m8<-ggplot(merged_expression_table_normalized_stage_II_bck, aes(Conections, T2, z = Expr))   + geom_point(aes(colour=Expr))  +  theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+ xlim(0, 50) + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color =  "yellow")   + ylim(10,40) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)       + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m9<-ggplot(merged_expression_table_normalized_stage_III_bck, aes(Conections, T2, z = Expr))  + geom_point(aes(colour=Expr)) + theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))+ xlim(0, 50) +  geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "red") + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "yellow")   + ylim(10,40) +  guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(10,40)  + xlim(0, 50)     + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))

    m10<-ggplot(merged_expression_table_normalized_stage_I_bkc, aes(Conections, T2, z = Expr))   +  theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))   + geom_density_2d(bin=10)         + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color =   "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(10,40)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m11<-ggplot(merged_expression_table_normalized_stage_II_bkc, aes(Conections, T2, z = Expr))  +  theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))   + geom_density_2d(bin=10)        + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color =  "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m12<-ggplot(merged_expression_table_normalized_stage_III_bkc, aes(Conections, T2, z = Expr)) +  theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))   + geom_density_2d(bin=10)       + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "red") + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 1), breaks = seq(0, 40, by = 10), limits = c(10, 40))  
    ...
    png(filename=paste(output_dir,"countour_T2_Coonections_melt_",normalization_scheme,"_",TCGA_project,"_Stage_all_T2.png",sep=""), width = 30, height = 60, res=600, units = "cm")  
            plot<-ggarrange(m7, m8, m9, m10, m11,m12, m1,m2,m3,m4,m5,m6, nrow = 4,ncol = 3, common.legend = TRUE, legend="bottom")
            annotate_figure(plot, top = text_grob(TCGA_project, face = "bold", size = 14))
    dev.off()  
  

    m1<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections, GC3, z = Expr))   + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+ geom_density_2d()         + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$GC3), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$GC3), linetype="dashed", color =   "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))   + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 5), limits = c(25, 85))
    m2<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections, GC3, z = Expr))  + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+ geom_density_2d()        + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$GC3), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$GC3), linetype="dashed", color =  "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))   + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 5), limits = c(25, 85))
    m3<-ggplot(merged_expression_table_normalized_stage_III, aes(Conections, GC3, z = Expr))  + geom_density_2d_filled(alpha = 0.5) + theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+ geom_density_2d()        + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$GC3), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$GC3), linetype="dashed", color =  "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))   + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 5), limits = c(25, 85))
    ...
    m7<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections, GC3, z = Expr))  + geom_point(aes(colour=Expr))   +  theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+ geom_density_2d()  + xlim(0, 50)       + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$GC3), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color =   "yellow")   + ylim(10,40) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(25,85)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 5), limits = c(25, 85))
    m8<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections, GC3, z = Expr))  + geom_point(aes(colour=Expr))  +  theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+ geom_density_2d()  + xlim(0, 50) + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$GC3), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color =  "yellow")   + ylim(10,40) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))       + ylim(25,85)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 5), limits = c(25, 85))
    m9<-ggplot(merged_expression_table_normalized_stage_III, aes(Conections, GC3, z = Expr))  + geom_point(aes(colour=Expr)) + theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))+ geom_density_2d()  + xlim(0, 50) +  geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$GC3), linetype="dashed", color = "red") + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "yellow")   + ylim(10,40) +  guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))    + ylim(25,85)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(25, 85, by = 1), breaks = seq(25, 85, by = 5), limits = c(25, 85))
