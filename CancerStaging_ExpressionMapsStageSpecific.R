...
{     
    ...
    # FindClusters_resolution               
    png(filename=paste(output_dir,"countour_T2_Coonections_melt_",normalization_scheme,"_",TCGA_project,"_Stage_all_filtered.png",sep=""), width = 30, height = 50, res=600, units = "cm")  
            plot<-ggarrange(m7, m8, m9, m1,m2,m3,m4,m5,m6, nrow = 3,ncol = 3, common.legend = TRUE, legend="bottom")
            annotate_figure(plot, top = text_grob(TCGA_project, face = "bold", size = 14))
    dev.off()        
}
