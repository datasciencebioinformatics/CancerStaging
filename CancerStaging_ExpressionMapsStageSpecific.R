...
{     
    ...
    m1<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections, T2, z = Expr))  + geom_point(aes(colour=Expr)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": All points Stage I Expr. ",sep=""))+ geom_contour()         + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$T2), linetype="dashed", color =   "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(10,40)  + xlim(0, 50)   + scale_y_continuous(minor_breaks = seq(0, 40, by = 2), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m2<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections, T2, z = Expr))  + geom_point(aes(colour=Expr)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,   ": All points Stage II Expr. ",sep=""))+ geom_contour()        + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color = "red")   + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$T2), linetype="dashed", color =  "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 2), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    m3<-ggplot(merged_expression_table_normalized_stage_III, aes(Conections, T2, z = Expr))  + geom_point(aes(colour=Expr)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,  ": All points Stage III Expr. ",sep=""))+ geom_contour()       + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "red") + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$Conections), linetype="dashed", color = "yellow")  +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_III$T2), linetype="dashed", color = "yellow")   + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))  + ylim(10,40)  + xlim(0, 50)  + scale_y_continuous(minor_breaks = seq(0, 40, by = 2), breaks = seq(0, 40, by = 10), limits = c(10, 40))
    
    m4 <- ggplot(merged_expression_table_normalized_all_stages, aes(x=Stages, y=T2)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()           +  geom_hline(yintercept=median(merged_expression_table_normalized_all_stages$T2), linetype="dashed", color = "red")    + ggtitle(paste("T2 All points: ", normalization_scheme,sep=""))                   +  stat_compare_means(comparisons = my_comparisons, method = "t.test") + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) + ylim(0,60)   + scale_y_continuous(minor_breaks = seq(0, 40, by = 2), breaks = seq(0, 40, by = 10), limits = c(0, 80))
    ...
    png(filename=paste(output_dir,"countour_T2_Coonections_melt_",normalization_scheme,"_",TCGA_project,"_Stage_all.png",sep=""), width = 30, height = 50, res=600, units = "cm")  
    ...
    # Filter up Average expression greater than zero        
    m1<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage I Z-score",sep=""))+ geom_contour()        + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_I$Conections_z_score), linetype="dashed", color = "red")   +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_I$T2_z_score), linetype="dashed", color = "red")        + geom_vline(xintercept=median(merged_expression_table_normalized_stage_I$T2_z_score), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_I$Conections_z_score), linetype="dashed", color = "yellow")+xlim(0,4)+ylim(-2,2) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))     
    m2<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage II Z-score",sep=""))+ geom_contour()      + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_II$Conections_z_score), linetype="dashed", color = "red")  +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_II$T2_z_score), linetype="dashed", color = "red")      + geom_vline(xintercept=median(merged_expression_table_normalized_stage_II$T2_z_score), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_II$Conections_z_score), linetype="dashed", color = "yellow")+xlim(0,4)+ylim(-2,2) + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE))    
    m3<-ggplot(merged_expression_table_normalized_stage_III, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage III Z-score",sep=""))+ geom_contour()    + geom_vline(xintercept=mean(merged_expression_table_normalized_stage_III$Conections_z_score), linetype="dashed", color = "red") +  geom_hline(yintercept=mean(merged_expression_table_normalized_stage_III$T2_z_score), linetype="dashed", color = "red")     + geom_vline(xintercept=median(merged_expression_table_normalized_stage_III$T2_z_score), linetype="dashed", color = "yellow") +  geom_hline(yintercept=median(merged_expression_table_normalized_stage_III$Conections_z_score), linetype="dashed", color = "yellow")+xlim(0,4)+ylim(-2,2)  + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) 

    m4 <- ggplot(merged_expression_table_normalized_all_stages, aes(x=Stages, y=T2_z_score)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()           +  geom_hline(yintercept=mean(merged_expression_table_normalized_all_stages$T2_z_score), linetype="dashed", color = "red")    + ggtitle(paste("T2 z-score: ", normalization_scheme,sep=""))                    + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) 
    m5 <- ggplot(merged_expression_table_normalized_all_stages, aes(x=Stages, y=Conections_z_score)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()   +  geom_hline(yintercept=mean(merged_expression_table_normalized_all_stages$Conections_z_score), linetype="dashed", color = "red")    + ggtitle(paste("Connectivity z-score: ", normalization_scheme,sep=""))  + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) 
    m6 <- ggplot(merged_expression_table_normalized_all_stages, aes(x=Stages, y=Exp_z_score)) +  geom_violin(trim=FALSE) + stat_summary(fun.data="mean_sdl", geom="crossbar", width=0.2,color="red" )+ theme_bw()          +  geom_hline(yintercept=mean(merged_expression_table_normalized_all_stages$Exp_z_score), linetype="dashed", color = "red")    + ggtitle(paste("Expr. Z-score: ", normalization_scheme,sep=""))                + guides(x = guide_axis(minor.ticks = TRUE),y = guide_axis(minor.ticks = TRUE)) 
      
    # FindClusters_resolution               
    png(filename=paste(output_dir,"countour_T2_Coonections_zscore_",normalization_scheme,"_",TCGA_project,"_Stage_all.png",sep=""), width = 30, height = 50, res=600, units = "cm")  
            plot<-ggarrange(m1,m2,m3,m4,m5,m6, nrow = 2,ncol = 3, common.legend = TRUE, legend="bottom")
            annotate_figure(plot, top = text_grob(TCGA_project, face = "bold", size = 14))
    dev.off()  
    #########################################################################################################################################    
}
