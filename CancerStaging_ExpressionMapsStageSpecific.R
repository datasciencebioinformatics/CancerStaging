...
{     
   ...
   ####################################################################################################################################################################
    ...
    m1<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage I Expr. vs .Conections",sep=""))+ geom_contour()    + xlim(-1,1.0)+ylim(-0.10,0.10)        #  + theme(legend.position="none")        
    m2<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage II Expr. vs .Conections",sep=""))+ geom_contour()    + xlim(-1,1.0)+ylim(-0.10,0.10)        #  + theme(legend.position="none")        
    m3<-ggplot(merged_expression_table_normalized_stage_III, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage III Expr. vs .Conections",sep=""))+ geom_contour()  +  xlim(-1,1.0)+ylim(-0.10,0.10) #  + theme(legend.position="none")        
