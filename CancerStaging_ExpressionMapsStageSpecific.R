...
{     
    ...
    # Stage specific genes from each stage
    expression_table_normalized_stage_I  <-expression_table_normalized[genes_stages_I,list_of_comparisson[["sample_stage_I"]]]
    expression_table_normalized_stage_II <-expression_table_normalized[genes_stages_I,list_of_comparisson[["sample_stage_II"]]]
    expression_table_normalized_stage_III<-expression_table_normalized[genes_stages_I,list_of_comparisson[["sample_stage_III"]]]
    ...
    # Set AveExp to zero Interactomes_GC3_T2_merged
    Interactomes_GC3_T2_merged_Stage_I   <-Interactomes_GC3_T2_merged[ENSEMBL_ids_stage_I,]
    Interactomes_GC3_T2_merged_Stage_II  <-Interactomes_GC3_T2_merged[ENSEMBL_ids_stage_I,]
    Interactomes_GC3_T2_merged_Stage_III <-Interactomes_GC3_T2_merged[ENSEMBL_ids_stage_I,]
    ...
    # Calculate the average expression for the epression of each g
    Interactomes_GC3_T2_merged_Stage_I[ENSEMBL_ids_stage_I,"AveExp"]<-rowMeans(expression_table_normalized_stage_I[ENSEMBL_ids_stage_I,])
    Interactomes_GC3_T2_merged_Stage_II[ENSEMBL_ids_stage_II,"AveExp"]<-rowMeans(expression_table_normalized_stage_II[ENSEMBL_ids_stage_I,])
    Interactomes_GC3_T2_merged_Stage_III[ENSEMBL_ids_stage_III,"AveExp"]<-rowMeans(expression_table_normalized_stage_III[ENSEMBL_ids_stage_I,])
    
    # merged_expression_interactomes
    merged_expression_table_normalized_stage_I <-cbind(expression_table_normalized_stage_I[ENSEMBL_ids_stage_I,],Interactomes_GC3_T2_merged_Stage_I[Interactomes_GC3_T2_merged_Stage_I$ENSEMBL %in% ENSEMBL_ids_stage_I,c("T2","GC3","Conections","ENSEMBL")])
    merged_expression_table_normalized_stage_II<-cbind(expression_table_normalized_stage_II[ENSEMBL_ids_stage_I,],Interactomes_GC3_T2_merged_Stage_II[Interactomes_GC3_T2_merged_Stage_II$ENSEMBL %in% ENSEMBL_ids_stage_I,c("T2","GC3","Conections","ENSEMBL")])  
    merged_expression_table_normalized_stage_III<-cbind(expression_table_normalized_stage_III[ENSEMBL_ids_stage_I,],Interactomes_GC3_T2_merged_Stage_III[Interactomes_GC3_T2_merged_Stage_III$ENSEMBL %in% ENSEMBL_ids_stage_I,c("T2","GC3","Conections","ENSEMBL")])  
    ...
    merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$ENSEMBL %in% unique_stage_I,"Stages"]<-"Stage I"
    merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$ENSEMBL %in% unique_stage_I,"Stages"]<-"Stage II"
    merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$ENSEMBL %in% unique_stage_I,"Stages"]<-"Stage III"    
    #########################################################################################################################################    
    ...
    #########################################################################################################################################
    # Filter up Average expression greater than zero
    merged_expression_table_normalized_stage_I<-merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$variable %in% list_of_comparisson[["sample_stage_I"]],]
    merged_expression_table_normalized_stage_II<-merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$variable %in% list_of_comparisson[["sample_stage_II"]],]
    merged_expression_table_normalized_stage_III<-merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$variable %in% list_of_comparisson[["sample_stage_III"]],]
    ...
    # FindClusters_resolution               
    png(filename=    # Filter up Average expression greater than zero
    merged_expression_table_normalized_stage_I<-merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$variable %in% list_of_comparisson[["sample_stage_I"]],]
    merged_expression_table_normalized_stage_II<-merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$variable %in% list_of_comparisson[["sample_stage_II"]],]
    merged_expression_table_normalized_stage_III<-merged_expression_table_normalized_all_stages[merged_expression_table_normalized_all_stages$variable %in% list_of_comparisson[["sample_stage_III"]],]
    ...
    png(filename=paste(output_dir,"countour_T2_Coonections_zscore_",normalization_scheme,"_Stage_all.png",sep=""), width = 30, height = 25, res=600, units = "cm")  
            ggarrange(m1,m2,m3,m4,m5,m6, nrow = 2,ncol = 3, common.legend = TRUE, legend="bottom")
    dev.off()  
    #########################################################################################################################################    paste(output_dir,"countour_T2_Coonections_melt_",normalization_scheme,"_Stage_all.png",sep=""), width = 30, height = 25, res=600, units = "cm")  
            ggarrange(m1,m2,m3,m4,m5,m6, nrow = 2,ncol = 3, common.legend = TRUE, legend="bottom")
    dev.off()  
