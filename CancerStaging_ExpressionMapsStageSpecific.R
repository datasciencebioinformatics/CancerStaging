...
{     
   ...
   ####################################################################################################################################################################
    ...
    m1<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections, T2, z = Expr))  + geom_point(aes(colour=Expr)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage I Expr. vs .Conections : 0-50",sep=""))+ geom_contour()  + xlim(0, 50) + ylim(0, 50)      #  + theme(legend.position="none")        a
    m2<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections, T2, z = Expr))  + geom_point(aes(colour=Expr)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,   ": Stage II Expr. vs .Conections : 0-50",sep=""))+ geom_contour()  + xlim(0, 50) + ylim(0, 50)      #  + theme(legend.position="none")        a
    ...
    m1<-ggplot(merged_expression_table_normalized_stage_I, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage I Expr. vs .Conections : 0-50",sep=""))+ geom_contour()  + xlim(min(merged_expression_table_normalized_stage_I$Conections_z_score)-1, max(merged_expression_table_normalized_stage_I$Conections_z_score)) + ylim(min(merged_expression_table_normalized_stage_I$T2_z_score)-1, max(merged_expression_table_normalized_stage_I$T2_z_score))        #  + theme(legend.position="none")        
    m2<-ggplot(merged_expression_table_normalized_stage_II, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage I Expr. vs .Conections : 0-50",sep=""))+ geom_contour()  + xlim(min(merged_expression_table_normalized_stage_II$Conections_z_score)-1, max(merged_expression_table_normalized_stage_II$Conections_z_score)) + ylim(min(merged_expression_table_normalized_stage_II$T2_z_score)-1, max(merged_expression_table_normalized_stage_II$T2_z_score))    #  + theme(legend.position="none")       
    m3<-ggplot(merged_expression_table_normalized_stage_III, aes(Conections_z_score, T2_z_score, z = Exp_z_score))  + geom_point(aes(colour=Exp_z_score)) + geom_density_2d_filled() + theme_bw() + ggtitle(paste(normalization_scheme,    ": Stage I Expr. vs .Conections : 0-50",sep=""))+ geom_contour()  + xlim(min(merged_expression_table_normalized_stage_III$Conections_z_score)-1, max(merged_expression_table_normalized_stage_III$Conections_z_score)) + ylim(min(merged_expression_table_normalized_stage_III$T2_z_score)-1, max(merged_expression_table_normalized_stage_III$T2_z_score))#  + theme(legend.position="none")        
